            ...
            <div id="carousel-example-generic" class="carousel slide" data-ride="carousel" style="background-color:#000; padding:10px;">
              ...
              <div class="carousel-inner">
                <div class="item active">
                  <img src="images/bonbon.jpg" alt="" class=" img-responsive wow fadeInDown">
                </div>
                <div class="item">
        ...
        <div class="col-md-3" >
            ...
            <div class="panel panel-default wow fadeInDown">
              ...
              <ul class="list-group">
                ...
                <li class="list-group-item wow fadeInDown">Wedding Cake - <span style="color:#8B8B00; font-weight:bold;">Ugshs 420000</span> <span style="color:#EE5C42;" class="glyphicon glyphicon-ok pull-right"></span></li>
                 <li class="list-group-item wow fadeInDown">Simple Cake  - <span style="color:#8B8B00; font-weight:bold;">Ugshs 35000 </span> <span style="color:#EE5C42;" class="glyphicon glyphicon-ok pull-right"></span></li>
                  <li class="list-group-item wow fadeInDown">Gift Cake  - <span style="color:#8B8B00; font-weight:bold;">Ugshs 75000 </span> <span style="color:#EE5C42;" class="glyphicon glyphicon-ok pull-right"></span></li>
...
<footer id="footer" class="midnight-blue wow fadeInDown">
        <div class="container">
            <div class="row">
                ...
                &copy; 2018<a target="_blank" href="#" title="#">Cakes</a>. All Rights Reserved.
                </div>
                <div class="col-sm-6">
